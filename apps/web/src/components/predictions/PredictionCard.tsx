      ...
      >
        ...
        {isConnected && (
          <button
            ...
            className="mt-3 w-full py-2 text-xs font-medium text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 rounded-lg hover:bg-emerald-500/20 transition-colors"
          >
            Trade
          </button>
        )}
